  ...
  return (
    <div className="py-10 bg-gray-100 ">
      <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg  lg:max-w-4xl">
        <div className="hidden bg-cover lg:block lg:w-1/2 signUp-image"></div>
        ...
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2 ">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mt-6">
              <button
                type="submit"
                className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#F86263] rounded-lg hover:bg-[#e24d4d] focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50"
              >
                Sign In
              </button>
            </div>
